...
The goal of this portfolio was to explore the experience of vizualizations within R. The results were less than stellar. In general, I found that I prefer to make the visualizations outside of R. However, it was valuable to learn about this.
...
>After a lot of searching, I've decided that using R this way is a terrible way of getting correlations tables, and making them in word is going to remain my primary way of handling them. In a way, much of what I learned in these portfolios is that I prefer to do everything that isn't the actual analyses outside of R.
...
Once that is done, here is the actual code to get the html output. I couldn't figure out how to embed html into the knited document, and since I don't intend to use this methodology in the future, it didn't seem like a productive rabbit hole to fall down.
